...
export default function DEI() {
  ...
  const photos = [
    {
      label: get("dei.photo_0.label", "Lunar New Year Celebration"),
      imageUrl: get("dei.photo_0.image_url", ""),
      hide: get("dei.photo_0.hide_image", "false") === "true",
      from: "from-amber-900",
      via: "via-stone-700",
      to: "to-stone-600",
    },
    {
      label: get("dei.photo_1.label", "Holi Celebration"),
      imageUrl: get("dei.photo_1.image_url", ""),
      hide: get("dei.photo_1.hide_image", "false") === "true",
      from: "from-rose-700",
      via: "via-purple-600",
      to: "to-sky-500",
    },
    ...
    <>
      ...
      {photos.length > 0 && (
        <section className="px-6 md:px-16 pb-16 md:pb-24">
          <div className={`max-w-5xl mx-auto grid gap-6 ${photos.length === 1 ? "grid-cols-1 max-w-2xl" : "grid-cols-1 sm:grid-cols-2"}`}>
